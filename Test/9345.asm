...
finito:
	...
	ret
blkline:				; blank line at cursor position
	ld de,(VDA_POS)
	push de
	ld e,0
	call EF_VDASCP
...
wr0:
	...
	ret
;
scrup:				; copy source DE line to cursor line
	ld de,(VDA_POS)
	push de
	ld de,0			; cursor to 1. line
	call EF_VDASCP
	ld b,DLINES-1
	ld de,$0100
scrup0:
...
scrdn:
	...
	ld de,(VDA_POS)
	push de
	ld de,(DLINES-1)*256			; cursor to last line
	call EF_VDASCP
	ld b,DLINES-1
	ld de,(DLINES-2)*256
scrd0:
...
;
EF_IDAT:
	.DB	0		;KBDMODE_NONE	; PS/2 8242 KEYBOARD CONTROLLER
	.DB	0
	.DB	0
;
VDA_POS:		.DW 0
...
TESTMATRIX:
 ...
 .TEXT "13      ==================================================================     3"
 .TEXT "14                                                                             4"
 .TEXT "15                       EF9345 TEST V0.1   VT-52 EMULATION                    5"
 .TEXT "16                                                                             6"
 .TEXT "17                  **  PRESS ANY KEY TO ENTER TERMINAL MODE **                7"
 .TEXT "18                                                                             8"
 .TEXT "19                                                                             9"
 .TEXT "21                                                                             0"
 .TEXT "22                                                                             1"
 .TEXT "23                                                                             2"
 .TEXT "24 34567890123456789012345678901234567890123456789012345678901234567890123456789$"
.list
